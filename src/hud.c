...
/*   Updated: 2021/02/09 15:39:16 by ecelsa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		hud_put_cells(t_hud *hud, t_hud_sub place, int par)
{
	int i;
...
void		put_hud(t_engine *engine)
{
	...
	hud_put_cells(hud, (t_hud_sub){.p_w = 5, .p_col = 8, .p_dist = 12,
							.p_dist2 = 5, .p_x = 111, .p_st = 1}, inp->weapons);
	hud_put_cells(hud, (t_hud_sub){.p_w = 6, .p_col = 10, .p_dist = 11,
